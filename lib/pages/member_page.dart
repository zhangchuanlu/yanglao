...
class MemberPage extends StatelessWidget {
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Text("技术胖",style: TextStyle(fontSize: ScreenUtil().setSp(36),color: Colors.black26),),
          )
        ],
      ),
    );
  ...
  Widget _orderTitle(context){
    return InkWell(
      ...
      onTap: (){
        Navigator.push(context, new MaterialPageRoute(builder: (context)=>EventBusDemo()));
      },
    );
  }
